...
from app.modules.dispatch.requirement_dispatch_agent.service import bootstrap_requirement_dispatch_state
...
from app.modules.reception.channel_ingress.wecom_ilink_poller_service import wecom_ilink_poller_service
...
async def lifespan(_: FastAPI):
    ...
    external_agent_registry_service.bootstrap()
    ...
    bootstrap_requirement_dispatch_state()
    ...
    wecom_ilink_poller_service.start()
    yield
    wecom_ilink_poller_service.stop()
