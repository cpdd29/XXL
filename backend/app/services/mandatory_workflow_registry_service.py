...
from app.services.mandatory_workflow_module_registry_service import (
    ...
    },
    {
        ...
        "nodes": [
            ...
            },
            {
                ...
                "agent_id": "conversation",
                "config": {
                    "instruction": "将当前诉求整理为查询类需求，不做任务分发。",
                    "result_kind": "query_request_packet",
                },
            },
            {
                "id": "5",
                ...
                "agent_id": "conversation",
                "config": {
                    "instruction": "面向查询类诉求确认客户需求，并补齐必要上下文。",
                    "result_kind": "conversation_confirmation",
                },
            },
            {
                "id": "6",
            ...
            },
            {
                ...
                "agent_id": "conversation",
                "config": {
                    "instruction": "将当前诉求整理为下发任务类需求，准备进入需求分发。",
                    "result_kind": "dispatch_request_packet",
                },
            },
            {
                "id": "8",
                ...
                "agent_id": "conversation",
                "config": {
                    "instruction": "面向下发任务类诉求确认客户需求，并补齐执行边界。",
                    "result_kind": "conversation_confirmation",
                },
            },
            {
            ...
            },
            {
                ...
                "agent_id": "conversation",
                "config": {
                    "instruction": "将上游最终处理信息语义化整理，输出清晰自然的结果摘要。",
                    "result_kind": "semantic_response",
                },
            },
            {
                "id": "11",
...
def _purge_legacy_workflows() -> None:
    ...
    from app.services.mandatory_agent_registry_service import purge_removed_workflow_agent_bindings
