...
from app.modules.reception.channel_ingress.wecom import WeComAdapter
from app.modules.reception.schemas.messages import ChannelType, normalize_channel_type
