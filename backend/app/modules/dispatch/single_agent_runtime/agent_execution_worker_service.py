...
from app.platform.contracts.event_protocol import summarize_payload_for_bus
...
class AgentExecutionWorkerService:
    ...
    def _consume_execution_job(self, job: dict) -> str:
        ...
        from app.modules.dispatch.workflow_runtime import workflow_execution_service
