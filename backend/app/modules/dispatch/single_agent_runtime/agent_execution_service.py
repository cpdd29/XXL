...
from app.modules.dispatch.multi_agent_runtime.professional_workflow_service import professional_workflow_service
...
class AgentExecutionService:
    ...
    def _execute_free_workflow(
        ...
        *,
        ...
        try:
            from app.modules.dispatch.single_agent_runtime.free_workflow_service import free_workflow_service
    ...
    def build_search_result(
        ...
        *,
        ...
        bullets.append(
            ...
            if language == "en"
            else "如需继续深挖，可结合任务详情日志继续补充上下文后重新执行。"
        )
        if context_notes:
            bullets.append(
        ...
        content_lines.extend(
            [
                ...
                (
                    ...
                    if language == "en"
                    else "3. 如仍无法解决，可转入任务详情继续追踪节点状态并追加上下文。"
                ),
            ]
        )
        bullets = [
