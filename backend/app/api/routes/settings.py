...
from app.services.config_governance_service import get_config_governance_snapshot
...
@router.get(
    "/governance",
    response_model=ConfigGovernanceResponse,
    dependencies=[Depends(require_permission("settings:read"))],
)
def get_config_governance_route() -> ConfigGovernanceResponse:
    return ConfigGovernanceResponse(**get_config_governance_snapshot())
